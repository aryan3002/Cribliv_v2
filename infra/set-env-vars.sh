...
OTP_CHANNEL_PRIMARY="${OTP_CHANNEL_PRIMARY:-sms}"   # whatsapp = WhatsApp first, D7 SMS as gated fallback
WHATSAPP_OTP_TEMPLATE_NAME="${WHATSAPP_OTP_TEMPLATE_NAME:-}"
WHATSAPP_OTP_EXPIRY_SEC="${WHATSAPP_OTP_EXPIRY_SEC:-300}"
WHATSAPP_ORIGINATOR="${WHATSAPP_ORIGINATOR:-}"   # E.164 number registered with D7
...
az containerapp update \
  ...
  --set-env-vars \
    ...
    WHATSAPP_ORIGINATOR="${WHATSAPP_ORIGINATOR}" \
