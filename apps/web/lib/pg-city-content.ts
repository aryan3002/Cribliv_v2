    ...
    faqs: [
      {
        ...
        a: "Single-sharing PGs in Delhi run ₹9,000–₹18,000/month; double and triple sharing are cheaper at ₹4,500–₹11,000. Mukherjee Nagar and Laxmi Nagar are the most affordable student belts."
      },
      {
        q: "Are food and meals included in Delhi PGs?",
        a: "Many Delhi PGs include 2–3 meals a day. Use the Food-included filter on Cribliv to see only PGs that bundle meals."
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Single sharing is ₹8,000–₹15,000/month; double/triple sharing ₹4,000–₹9,000. Sectors 62 and 137 are popular with IT professionals."
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Single sharing ₹10,000–₹20,000/month; double/triple ₹5,000–₹12,000. PGs near Cyber City and Udyog Vihar command a premium."
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Triple-sharing PGs start around ₹3,000/month; single sharing ₹6,000–₹12,000. Raj Nagar Extension is the most affordable."
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Single sharing ₹5,500–₹11,000/month; double/triple from ₹3,000. NIT and Sector 15 have the most options."
      },
      {
        q: "Are there PGs near the metro in Faridabad?",
        a: "Yes — the Violet Line corridor (Sectors 15–28) has several PGs."
      },
    ...
    faqs: [
      {
        ...
        a: "Single sharing ₹8,000–₹15,000/month; double/triple ₹4,000–₹9,500. PGs near Panjab University and IT Park are in highest demand."
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Single sharing ₹6,000–₹12,000/month; double/triple from ₹3,000. Malviya Nagar (MNIT) and Sitapura (JECRC) are popular student belts."
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Single sharing ₹6,000–₹12,000/month; double/triple from ₹3,000. Gomti Nagar is premium; Aliganj and Jankipuram are affordable student belts."
      },
      {
      ...
      },
      {
        ...
        a: "Many include 2–3 meals; use the Food-included filter to narrow down."
      },
      {
