...
export function ListingWizard({ locale: localeProp, mode, onPublished }: ListingWizardProps) {
  ...
  // Mode-aware so an in-progress admin on-behalf draft can never collide
  // with the owner's own draft in the same browser session.
  const STORAGE_KEY = useMemo(
    () => (mode === "admin" ? "cribliv:wizard-draft:admin" : "cribliv:wizard-draft"),
    [mode]
  );
